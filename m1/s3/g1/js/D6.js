...
numeri.forEach(function(numeri) {
...
/* 
let arr = ["EPICODE", "is", "great"]

function lunghezza(myArr) {

  let newArr = [];
  
  newArr = myArr.map(function(element) {
...
/* function older(myArr) {

  let memo = myArr[0];

  myArr.forEach(function(object) {

    if(object.Year < memo.Year){
